...
var app = (function () {
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-17eidh0");
    			add_location(h1, file$8, 1, 2, 12);
    			attr_dev(header, "class", "svelte-17eidh0");
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", button_class_value = "" + (/*mode*/ ctx[2] + " " + /*color*/ ctx[4] + " svelte-1a189ga"));
    			attr_dev(button, "type", /*type*/ ctx[0]);
    			add_location(button, file$7, 15, 2, 299);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!current || dirty & /*mode, color*/ 20 && button_class_value !== (button_class_value = "" + (/*mode*/ ctx[2] + " " + /*color*/ ctx[4] + " svelte-1a189ga"))) {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-1a189ga");
    			add_location(a, file$7, 11, 2, 246);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['type', 'href', 'mode', 'style', 'color'];
    	...
    	$$self.$capture_state = () => ({ type, href, mode, style, color });
    	...
    	return [type, href, mode, style, color, $$scope, slots, click_handler];
    }
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			if (default_slot) default_slot.c();
    			attr_dev(span, "class", "svelte-o10f12");
    ...
    function create_default_slot_2$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(41:4) <Button href=\\\"mailto:{email}\\\">",
    		ctx
    	});
    ...
    // (42:4) <Button        mode="outline"        color={!isFavourited ? "success" : ""}        on:click={addFavouriteEvent}      >
    function create_default_slot_1$1(ctx) {
    	let t_value = (/*isFavourited*/ ctx[6] ? "Unfavourite" : "Favourite") + "";
    	let t;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*isFavourited*/ 64 && t_value !== (t_value = (/*isFavourited*/ ctx[6] ? "Unfavourite" : "Favourite") + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(t);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(42:4) <Button        mode=\\\"outline\\\"        color={!isFavourited ? \\\"success\\\" : \\\"\\\"}        on:click={addFavouriteEvent}      >",
    		ctx
    	});
    ...
    function create_default_slot$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(49:4) <Button mode=\\\"last-button\\\">",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	let button2;
    	let current;
    	let if_block = /*isFavourited*/ ctx[6] && create_if_block$2(ctx);
    	...
    	button1 = new Button({
    			props: {
    				mode: "outline",
    				color: !/*isFavourited*/ ctx[6] ? "success" : "",
    	...
    	button1.$on("click", /*addFavouriteEvent*/ ctx[7]);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-xszsoy");
    			add_location(h1, file$5, 22, 4, 520);
    			attr_dev(h2, "class", "svelte-xszsoy");
    			add_location(h2, file$5, 28, 4, 623);
    			attr_dev(p0, "class", "svelte-xszsoy");
    			add_location(p0, file$5, 29, 4, 648);
    			attr_dev(header, "class", "svelte-xszsoy");
    			add_location(header, file$5, 21, 2, 506);
    			if (!src_url_equal(img.src, img_src_value = /*imageUrl*/ ctx[2])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-xszsoy");
    			add_location(img, file$5, 32, 4, 706);
    			attr_dev(div0, "class", "image svelte-xszsoy");
    			add_location(div0, file$5, 31, 2, 681);
    			attr_dev(p1, "class", "svelte-xszsoy");
    			add_location(p1, file$5, 35, 4, 776);
    			attr_dev(div1, "class", "content svelte-xszsoy");
    			add_location(div1, file$5, 34, 2, 749);
    			attr_dev(footer, "class", "svelte-xszsoy");
    			add_location(footer, file$5, 39, 2, 824);
    			attr_dev(article, "class", "svelte-xszsoy");
    			add_location(article, file$5, 20, 0, 493);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (/*isFavourited*/ ctx[6]) {
    				if (if_block) {
    					if (dirty & /*isFavourited*/ 64) {
    						transition_in(if_block, 1);
    					}
    				} else {
    			...
    			if (dirty & /*isFavourited*/ 64) button1_changes.color = !/*isFavourited*/ ctx[6] ? "success" : "";

    			if (dirty & /*$$scope, isFavourited*/ 1088) {
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	let { address } = $$props;
    	let { email } = $$props;
    	let { isFavourited } = $$props;
    	const dispatch = createEventDispatcher();

    	const addFavouriteEvent = () => {
    		dispatch("toggle-favourite", { meetupId: id });
    	};
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('isFavourited' in $$props) $$invalidate(6, isFavourited = $$props.isFavourited);
    	};
    ...
    class MeetupItem extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*isFavourited*/ ctx[6] === undefined && !('isFavourited' in props)) {
    			console.warn("<MeetupItem> was created without expected prop 'isFavourited'");
    		}
    	}
    	...
    	set isFavourited(value) {
    		throw new Error("<MeetupItem>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }

    /* src\Meetups\MeetupGridItem.svelte generated by Svelte v3.49.0 */
    const file$4 = "src\\Meetups\\MeetupGridItem.svelte";
    ...
    function create_each_block(key_1, ctx) {
    	...
    	meetupitem = new MeetupItem({
    			props: {
    				...
    				isFavourited: /*meetup*/ ctx[2].isFavourite
    			},
    			$$inline: true
    		});

    	meetupitem.$on("toggle-favourite", /*toggle_favourite_handler*/ ctx[1]);
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*meetups*/ 1) meetupitem_changes.isFavourited = /*meetup*/ ctx[2].isFavourite;
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "class", "svelte-fwwc8p");
    			add_location(section, file$4, 5, 0, 95);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('MeetupGridItem', slots, []);
    	let { meetups } = $$props;
    	const writable_props = ['meetups'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<MeetupGridItem> was created with unknown prop '${key}'`);
    	});
    	...
    	return [meetups, toggle_favourite_handler];
    }

    class MeetupGridItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		...
    		if (/*meetups*/ ctx[0] === undefined && !('meetups' in props)) {
    			console.warn("<MeetupGridItem> was created without expected prop 'meetups'");
    		}
    	}

    	get meetups() {
    		throw new Error("<MeetupGridItem>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set meetups(value) {
    		throw new Error("<MeetupGridItem>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			input.required = /*isRequired*/ ctx[4];
    			attr_dev(input, "name", /*id*/ ctx[2]);
    			attr_dev(input, "id", /*id*/ ctx[2]);
    			attr_dev(input, "class", "svelte-lbaaeg");
    			add_location(input, file$3, 19, 4, 712);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*isRequired*/ 16) {
    				prop_dev(input, "required", /*isRequired*/ ctx[4]);
    			}
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			textarea.required = /*isRequired*/ ctx[4];
    			attr_dev(textarea, "name", /*id*/ ctx[2]);
    			attr_dev(textarea, "row", /*row*/ ctx[5]);
    			attr_dev(textarea, "id", /*id*/ ctx[2]);
    			attr_dev(textarea, "class", "svelte-lbaaeg");
    			add_location(textarea, file$3, 17, 4, 609);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*isRequired*/ 16) {
    				prop_dev(textarea, "required", /*isRequired*/ ctx[4]);
    			}
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "id", /*id*/ ctx[2]);
    			attr_dev(input, "class", "svelte-lbaaeg");
    			add_location(input, file$3, 12, 4, 256);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, input, anchor);
    			set_input_value(input, /*value*/ ctx[0]);
    ...
    function create_fragment$3(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*type*/ ctx[3] === "text") return create_if_block$1;
    		if (/*type*/ ctx[3] === "textarea") return create_if_block_1;
    		if (/*type*/ ctx[3] === "email") return create_if_block_2;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(label_1, "class", "svelte-lbaaeg");
    			add_location(label_1, file$3, 10, 2, 194);
    			attr_dev(div, "class", "form-control svelte-lbaaeg");
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let { row = null } = $$props;
    	const writable_props = ['label', 'value', 'id', 'type', 'isRequired', 'row'];
    	...
    	$$self.$capture_state = () => ({ label, value, id, type, isRequired, row });
    ...
    class TextInput extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*isRequired*/ ctx[4] === undefined && !('isRequired' in props)) {
    			console.warn("<TextInput> was created without expected prop 'isRequired'");
    		}
    	}
    ...
    // (22:6) <Button on:click={closeModalEvent}>
    function create_default_slot$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(22:6) <Button on:click={closeModalEvent}>",
    		ctx
    	});
    ...
    function fallback_block(ctx) {
    	...
    	button.$on("click", /*closeModalEvent*/ ctx[1]);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "modal-backdrop svelte-1sx7l41");
    			add_location(div0, file$2, 13, 0, 253);
    			attr_dev(h1, "class", "svelte-1sx7l41");
    			add_location(h1, file$2, 15, 2, 335);
    			attr_dev(div1, "class", "content svelte-1sx7l41");
    			add_location(div1, file$2, 16, 2, 355);
    			attr_dev(footer, "class", "svelte-1sx7l41");
    			add_location(footer, file$2, 19, 2, 404);
    			attr_dev(div2, "class", "modal svelte-1sx7l41");
    			add_location(div2, file$2, 14, 0, 312);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div0, "click", /*closeModalEvent*/ ctx[1], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [title, closeModalEvent, slots, $$scope];
    }
    ...
    // (43:0) <Modal title="Meetup Form" on:cancel>
    function create_default_slot_2(ctx) {
    	...
    	if (/*address*/ ctx[4] !== void 0) {
    		textinput2_props.value = /*address*/ ctx[4];
    	}
    	...
    	if (/*imageUrl*/ ctx[3] !== void 0) {
    		textinput3_props.value = /*imageUrl*/ ctx[3];
    	}
    	...
    	if (/*contactEmail*/ ctx[5] !== void 0) {
    		textinput4_props.value = /*contactEmail*/ ctx[5];
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file$1, 43, 2, 872);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(form, "submit", prevent_default(/*addMeetupEvent*/ ctx[6]), false, true, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    			...
    			if (!updating_value_2 && dirty & /*address*/ 16) {
    				updating_value_2 = true;
    				textinput2_changes.value = /*address*/ ctx[4];
    			...
    			if (!updating_value_3 && dirty & /*imageUrl*/ 8) {
    				updating_value_3 = true;
    				textinput3_changes.value = /*imageUrl*/ ctx[3];
    			...
    			if (!updating_value_4 && dirty & /*contactEmail*/ 32) {
    				updating_value_4 = true;
    				textinput4_changes.value = /*contactEmail*/ ctx[5];
    			...
    			if (!updating_value_5 && dirty & /*description*/ 4) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(43:0) <Modal title=\\\"Meetup Form\\\" on:cancel>",
    		ctx
    	});
    ...
    // (88:4) <Button type="button" mode="outline" on:click={cancelEvent}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(88:4) <Button type=\\\"button\\\" mode=\\\"outline\\\" on:click={cancelEvent}>",
    		ctx
    	});
    ...
    // (89:4) <Button type="button" on:click={addMeetupEvent}>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(89:4) <Button type=\\\"button\\\" on:click={addMeetupEvent}>",
    		ctx
    	});
    ...
    function create_footer_slot(ctx) {
    	...
    	button0.$on("click", /*cancelEvent*/ ctx[7]);
    	...
    	button1.$on("click", /*addMeetupEvent*/ ctx[6]);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 86, 2, 1837);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, description, contactEmail, imageUrl, address, subtitle, title*/ 131135) {
    ...
    // (114:4) <Button on:click={() => (editMode = "add")}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(114:4) <Button on:click={() => (editMode = \\\"add\\\")}>",
    		ctx
    	});
    ...
    // (116:2) {#if editMode === "add"}
    function create_if_block(ctx) {
    	let editmeetup;
    	let current;
    	editmeetup = new EditMeetup({ $$inline: true });
    	editmeetup.$on("add-meetup", /*addMeetup*/ ctx[2]);
    ...
    function create_fragment(ctx) {
    	...
    	meetupgriditem = new MeetupGridItem({
    			props: { meetups: /*meetups*/ ctx[0] },
    			$$inline: true
    		});

    	meetupgriditem.$on("toggle-favourite", /*toggleFavourite*/ ctx[4]);
    	...
    	const block = {
    		c: function create() {
    			...
    			if (if_block) if_block.c();
    			t2 = space();
    			create_component(meetupgriditem.$$.fragment);
    			attr_dev(div, "class", "meetup-controls svelte-17u5c6d");
    			add_location(div, file, 112, 2, 3278);
    			attr_dev(main, "class", "svelte-17u5c6d");
    			add_location(main, file, 111, 0, 3269);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, t2);
    			mount_component(meetupgriditem, main, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			const button_changes = {};
    			...
    			const meetupgriditem_changes = {};
    			if (dirty & /*meetups*/ 1) meetupgriditem_changes.meetups = /*meetups*/ ctx[0];
    			meetupgriditem.$set(meetupgriditem_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			...
    			transition_in(button.$$.fragment, local);
    			transition_in(if_block);
    			transition_in(meetupgriditem.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			...
    			transition_out(button.$$.fragment, local);
    			transition_out(if_block);
    			transition_out(meetupgriditem.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			...
    			if (if_block) if_block.d();
    			destroy_component(meetupgriditem);
    		}
    	};
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const addMeetup = e => {
    		...
    		const newMeetup = {
    			...
    			contactEmail: meetupData.contactEmail,
    			isFavourite: false
    		};

    		$$invalidate(0, meetups = [...meetups, newMeetup]);

    		// pushlamak ile dom trigger edilmiyor.. bu yüzden "=" ile güncelliyoruz
    		localStorage.setItem("meetups", JSON.stringify(meetups));

    		meetupData.resetValues();

    		// EditMeetup componentinden gönderdiğimiz resetValues fonksiyonunu burda çalıştırdık
    	...
    	const toggleFavourite = e => {
    		const id = e.detail.meetupId;

    		// sadece find ile
    		const updatedMeetups = [...meetups];

    		meetups.find((item, index) => {
    			if (item.id === id) {
    				item.isFavourite = !item.isFavourite;
    				updatedMeetups[index] = item;
    				return true;
    			}
